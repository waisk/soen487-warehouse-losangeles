 ...
 * 
 */
@WebServiceClient(name = "ManufactureWS", targetNamespace = "http://manufacture/", wsdlLocation = "http://54.186.189.163:8080/ManufactureWS/ManufactureWS_MiBookPro?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://54.186.189.163:8080/ManufactureWS/ManufactureWS_MiBookPro?wsdl");
     ...
     * 
     * @return
     *     returns ManufactureWSMiBookPro
     */
    @WebEndpoint(name = "ManufactureWS_MiBookProPort")
    public ManufactureWSMiBookPro getManufactureWSMiBookProPort() {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiBookProPort"), ManufactureWSMiBookPro.class);
    }
     ...
     */
    @WebEndpoint(name = "ManufactureWS_MiBookProPort")
    public ManufactureWSMiBookPro getManufactureWSMiBookProPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiBookProPort"), ManufactureWSMiBookPro.class, features);
    }
