 ...
 * 
 */
@WebServiceClient(name = "ManufactureWS", targetNamespace = "http://manufacture/", wsdlLocation = "http://54.186.176.247:8080/ManufactureWS/ManufactureWS_MiBookAir?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://54.186.176.247:8080/ManufactureWS/ManufactureWS_MiBookAir?wsdl");
     ...
     * 
     * @return
     *     returns ManufactureWSMiBookAir
     */
    @WebEndpoint(name = "ManufactureWS_MiBookAirPort")
    public ManufactureWSMiBookAir getManufactureWSMiBookAirPort() {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiBookAirPort"), ManufactureWSMiBookAir.class);
    }
     ...
     */
    @WebEndpoint(name = "ManufactureWS_MiBookAirPort")
    public ManufactureWSMiBookAir getManufactureWSMiBookAirPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiBookAirPort"), ManufactureWSMiBookAir.class, features);
    }
