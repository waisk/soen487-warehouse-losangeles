 ...
 * 
 */
@WebServiceClient(name = "ManufactureWS", targetNamespace = "http://manufacture/", wsdlLocation = "http://54.186.105.181:8080/ManufactureWS/ManufactureWS_MiPod?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://54.186.105.181:8080/ManufactureWS/ManufactureWS_MiPod?wsdl");
     ...
     * 
     * @return
     *     returns ManufactureWSMiPod
     */
    @WebEndpoint(name = "ManufactureWS_MiPodPort")
    public ManufactureWSMiPod getManufactureWSMiPodPort() {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiPodPort"), ManufactureWSMiPod.class);
    }
     ...
     */
    @WebEndpoint(name = "ManufactureWS_MiPodPort")
    public ManufactureWSMiPod getManufactureWSMiPodPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://manufacture/", "ManufactureWS_MiPodPort"), ManufactureWSMiPod.class, features);
    }
